...
void CStarWarsCtrl::PreSubclassWindow() 
{
	...
	m_TextLines.Add("亲爱的其其");
	m_TextLines.Add("");
	m_TextLines.Add("在我彷徨迷茫的时候 ");
	m_TextLines.Add("");
	m_TextLines.Add("你,是我前进的最大动力");
	m_TextLines.Add("");
	m_TextLines.Add("在我伤心失落的时候");
	m_TextLines.Add("");


	m_TextLines.Add("你,是我振作的最大理由");
	m_TextLines.Add("");
	m_TextLines.Add("很感谢你");
	m_TextLines.Add("");
	m_TextLines.Add("感谢你一直以来的支持和鼓励");
	m_TextLines.Add("");
	m_TextLines.Add("永远爱你");
	m_TextLines.Add("");
	m_TextLines.Add("永远爱你...");
	m_TextLines.Add("");
	m_TextLines.Add("永远爱你的梁志先");
	m_TextLines.Add("");
	m_TextLines.Add("星空旋律");
